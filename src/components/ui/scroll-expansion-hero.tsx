            ...
            <div className='flex flex-col items-center justify-center w-full h-screen relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {subtitle && (
                    <p
                      className='text-lg sm:text-xl md:text-2xl text-foreground/80'
                  ...
                  {scrollToExpand && (
                    <p
                      className='text-foreground/70 font-medium text-center text-sm sm:text-base'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h1
                  className='text-4xl md:text-5xl lg:text-7xl font-bold text-foreground transition-none'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h1>
                <motion.h1
                  className='text-4xl md:text-5xl lg:text-7xl font-bold text-center bg-gradient-to-r from-accent via-primary to-accent bg-clip-text text-transparent transition-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h1>
